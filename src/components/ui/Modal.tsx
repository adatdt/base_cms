...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={`relative z-10 w-full bg-white p-6 shadow-xl dark:bg-gray-800 rounded-2xl transition-all duration-200 ease-out 
          ${sizeClasses[size]} 
      ...
      >
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          {onConfirm ? (
            ...
            >
              {confirmLoading ? "Memproses..." : (confirmText ?? "Simpan")}
            </button>
          ) : (
            <button
              type="submit"
