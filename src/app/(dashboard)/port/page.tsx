...
export default function PortGridDashboardPage() {
    ...
    const filteredPorts = useMemo(() => {
        return portsData.filter((port) => {
            ...
            const matchesStatus =
                selectedStatus === "Semua" || port.status === selectedStatus;
    ...
    const columns: ColumnProps<PortRowData>[] = [
        {
            ...
            header: "Kode Node",
            className:
                "w-24 font-mono text-slate-500 group-hover:text-blue-600 font-medium",
        },
        {
            key: "name",
